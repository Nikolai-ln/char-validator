<?php
/**
 * charvalidator class file.
 *
 * @author Nikolay L Nikolov
 */

/**
 * charvalidator validates that the attribute value is a alphabetic/alphanumeric string.
 *
 * @author Nikolay L Nikolov
 */
 namespace nln\chars;
...
class CharValidator extends Validator
{
	...
	public function validateAttribute($object, $attribute)
	{
		...
		$message = $this->message ? $this->message : Yii::t('charvalidator', '{attribute} contains not allowed characters');
	...
	public function clientValidateAttribute($object, $attribute, $view)
	{
		...
		$pattern = $this->elaboratePattern();
		// get the error message
		$message = $this->message ? str_replace('{attribute}', $attribute, $this->message) : Yii::t('charvalidator', $attribute.' contains not allowed characters', array('{attribute}' => $attribute));
